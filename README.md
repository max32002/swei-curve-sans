...
「獅尾彎黑體」與「獅尾圓體」的主要差別在筆觸是否有做調整，獅尾彎黑體所套用的效果較少，在筆觸沒有做調整。
...
@font-face {
  ...
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-curve-sans@2.0/WebFont/CJK%20TC/SweiCurveSansCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-curve-sans@2.0/WebFont/CJK%20TC/SweiCurveSansCJKtc-Regular.woff) format("woff");
}
```
...
* 演算黑科技將字體變圓改造，請參考 /python/ 目錄下的腳本檔案。透過調整程式碼，也許也可以產生出新的有趣字型。目前的程式應該還有很多錯誤或需要再加強的地方。請先把要處理的字型，轉成 FontForge 的 sfdir, 再透過程式去處理產生出來的檔案。
